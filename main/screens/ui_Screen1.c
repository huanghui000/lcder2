...
void ui_Screen1_screen_init(void)
{
    ...
    lv_obj_set_style_text_font(ui_LabelAddr, ui_font_get_simli_small(), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_size(ui_WeatherContent, 640, 110);
    ...
    ui_QuotePage = lv_obj_create(ui_WeatherContent);
    ui_clear_container_style(ui_QuotePage);
    lv_obj_set_size(ui_QuotePage, 160, 110);
    lv_obj_set_pos(ui_QuotePage, 480, 0);

    ui_LabelQuoteTitle = lv_label_create(ui_QuotePage);
    ui_style_page_label(ui_LabelQuoteTitle, 160, 0, 0, LV_TEXT_ALIGN_CENTER);
    lv_obj_add_flag(ui_LabelQuoteTitle, LV_OBJ_FLAG_HIDDEN);
    lv_label_set_text(ui_LabelQuoteTitle, "随机一句");

    ui_LabelQuoteText = lv_label_create(ui_QuotePage);
    lv_obj_set_width(ui_LabelQuoteText, 152);
    lv_obj_set_height(ui_LabelQuoteText, 72);
    lv_obj_set_pos(ui_LabelQuoteText, 4, 8);
    lv_label_set_long_mode(ui_LabelQuoteText, LV_LABEL_LONG_WRAP);
    lv_obj_set_style_text_color(ui_LabelQuoteText, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui_LabelQuoteText, LV_TEXT_ALIGN_LEFT, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_LabelQuoteText, ui_font_get_simli_small(), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_label_set_text(ui_LabelQuoteText, "    正在获取一句话...");

    ui_LabelQuoteAuthor = lv_label_create(ui_QuotePage);
    lv_obj_set_width(ui_LabelQuoteAuthor, 152);
    lv_obj_set_height(ui_LabelQuoteAuthor, LV_SIZE_CONTENT);
    lv_obj_set_pos(ui_LabelQuoteAuthor, 4, 92);
    lv_label_set_long_mode(ui_LabelQuoteAuthor, LV_LABEL_LONG_CLIP);
    lv_obj_set_style_text_color(ui_LabelQuoteAuthor, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui_LabelQuoteAuthor, LV_TEXT_ALIGN_RIGHT, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_LabelQuoteAuthor, ui_font_get_simli_small(), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_label_set_text(ui_LabelQuoteAuthor, "--");
}
